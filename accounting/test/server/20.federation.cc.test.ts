...
describe('Transaction endpoint', async () => {
  ...
  it('Requires the cc-node header', async () => {
    const response = await t.api.post("/cc/transaction", {}, undefined, 401)
  ...
  it('Requires the last-hash header', async () => {
    const response = await t.api.post("/cc/transaction", {}, { user: null, scopes: [], ccNode: 'trunk' }, 401)
  ...
  it('Checks the last-hash header [TODO: against the db]', async () => {
    const response = await t.api.post("/cc/transaction", {}, { user: null, scopes: [], ccNode: 'trunk', lastHash: 'qwer' }, 401)
  ...
  it('Checks the cc-node header [TODO: against the db]', async () => {
    const response = await t.api.post("/cc/transaction", {}, { user: null, scopes: [], ccNode: 'bla', lastHash: 'asdf' }, 401)
  ...
  it('Receives CC transactions', async () => {
    const response = await t.api.post("/cc/transaction", {}, { user: null, scopes: [], ccNode: 'trunk', lastHash: 'asdf' }, 200)
